<template>
  ...
  >
    ...
    >
      <div
        class="card-panel"
        @click="handleSetLineChartData('tests_num')"
      >
    ...
    >
      <div
        class="card-panel"
        @click="handleSetLineChartData('once_disqualification_num')"
      >
        ...
        <div class="card-panel-description">
          ...
          <count-to
            :start-val="0"
            :end-val="top.once_disqualification_num"
            :duration="5"
            class="card-panel-num"
          />
          <span
    ...
    >
      <div
        class="card-panel"
        @click="handleSetLineChartData('disqualification_num')"
      >
        ...
        <div class="card-panel-description">
          ...
          <count-to
            :start-val="0"
            :end-val="top.disqualification_num"
            :duration="2"
            class="card-panel-num"
          />
          <span
    ...
    >
      <div
        class="card-panel"
        @click="handleSetLineChartData('force_accept_num')"
      >
