  ...
  methods: {
    ...
    create() {
      this.$refs['obj_form'].validate(valid => {
        if (valid) {
          addMixRecordItem(this.record.id, this.item).then(response => {
    ...
    update() {
      this.$refs['obj_form'].validate(valid => {
        if (valid) {
          updateMixRecordItem(this.record.id, this.item.id, this.item).then(response => {
            const { data } = response.data
            this.item = data
